...
# # In bash, run python sepages/phenols_phthalates_DNAm/R/combp_EWAS_overlap.py  (code below)
...
path = "/home/slavakp/sepages/phenols_phthalates_DNAm/analysis/overlap/bed_files"
