...
# # In bash, run python sepages/phenols_phthalates_DNAm/R/combp_EWAS_agnostic.py (code below)
...
path = "/home/slavakp/sepages/phenols_phthalates_DNAm/analysis/agnostic/bed_files"
